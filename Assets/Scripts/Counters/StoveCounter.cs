            ...
            switch (state)
            {
                ...
                case State.Frying:
                    ...
                    if (fryingTimer > fryingRecipeSO.fryingTimerMax)
                    {
                        ...
                        OnProgressChanged?.Invoke(this, new IHasProgress.OnProgressChangedEventArgs
                        {
                            progressNormalized = fryingRecipeSO.fryingTimerMax / fryingTimer// fryingRecipeSO.fryingTimerMax
                        });
        ...
        if (!HasKitchenObject())
        {
            ...
            if (player.HasKitchenObject())
            {
                ...
                if (HasRecipeWithInput(player.GetKitchenObject().GetKitchenObjectSO()))
                {
                    ...
                    OnProgressChanged?.Invoke(this, new IHasProgress.OnProgressChangedEventArgs
                    {
                        progressNormalized = fryingTimer / fryingRecipeSO.fryingTimerMax // fryingRecipeSO.fryingTimerMax
                    });
